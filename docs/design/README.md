...
| Doc | Status | Summary |
|---|---|---|
| [AWS deployment design set (docs 00–04)](aws-deploy/) | design complete — ready to execute | Hosted home + delivery pipeline for collab-relay on AWS: project intent, logic design, structural design, implementation plan (M1–M4), and BDD test plan gating each milestone. |
